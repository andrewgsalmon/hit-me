...
function Player({ accessToken, recommended, handleSubmit, user, liked, artistFromParams, similarArtist, setSimilarArtist, handleSimilar, artistId, setArtistId }) {
      ...
      <section className='music-section'>
        <div className='spotify-player'>
          <div className='spotify-player__action spotify-player__action--shuffle'>
            ...
            <button className='spotify-player__action-button spotify-player__action-button--shuffle' type='submit' onClick={handleSimilar}>Get Similar Artist!</button>
          </div>
        ...
        <CommentSection recommended={recommended} user={user} artistId={artistId} setArtistId={setArtistId} />
      </section>
    </>
  )
}
